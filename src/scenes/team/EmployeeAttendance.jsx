...
const EmployeeAttendanceReports = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (role === "SuperAdmin" || role === "Admin") {
            response = await axios.get("https://ybillingapi.bsite.net/api/EmployeeAttendance");
          } 
            ...
            response = await axios.post(
              "https://ybillingapi.bsite.net/api/EmployeeAttendance/getallemployeesbyclient",
              {
  ...
  }, [dataLoaded, role, ClientName, employeeName]);
  ...
  return (
    <Box m="20px">
      <Header title="All Employees Attendance Report" subtitle="Managing the Attendance Reports" />
      <Box
        m="20px 0 0 0"
        height="75vh"
        sx={{
